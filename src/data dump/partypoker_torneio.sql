...
CREATE TABLE `torneio` (
  ...
  `rebuy` bit(1) NOT NULL,
  `titulo` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_1rf1qjb09vgxfjfq4xa1op2vo` (`titulo`)
...
INSERT INTO `torneio` VALUES (1,100,'12/12/2021','torneio de teste','10,000.00',_binary '\0','Torneio 2'),(2,100,'12/12/2021','torneio de teste','10,000.00',_binary '\0','Torneio 1');
